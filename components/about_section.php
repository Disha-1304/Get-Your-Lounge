<?php
// components/about_section.php
?>
<section id="about" style="padding: 80px 24px 60px; background: #FFFFFF; max-width: 1350px; margin: 0 auto;">
  
  <!-- Container Card adhering to luxury palette -->
  <div style="background: #F8F9FB; border-radius: 36px; padding: 56px 48px; border: 1px solid rgba(10, 25, 47, 0.15); box-shadow: 0 20px 45px -10px rgba(10, 25, 47, 0.12);">
    
    <!-- Top Banner Image Area -->
    <div style="display: flex; flex-direction: column; align-items: center; text-align: center; margin-bottom: 56px; border-bottom: 1px solid rgba(10, 25, 47, 0.12); padding-bottom: 48px;">
      <div style="background: #ffffff; padding: 20px 40px; border-radius: 24px; box-shadow: 0 12px 30px rgba(10, 25, 47, 0.08); margin-bottom: 28px; border: 1px solid rgba(10, 25, 47, 0.08); display: inline-flex; align-items: center; justify-content: center;">
        <img 
      ...
      <div style="display: inline-flex; align-items: center; gap: 8px; background: #FDECEF; color: #E61E38; padding: 6px 18px; border-radius: 999px; font-size: 13px; font-weight: 800; letter-spacing: 0.8px; text-transform: uppercase; margin-bottom: 16px; border: 1px solid #E61E38;">
        About FlyAnyTrip Ecosystem
      </div>

      <h2 style="font-size: clamp(28px, 4vw, 42px); font-weight: 800; color: #0A192F; max-width: 780px; line-height: 1.2;">
    ...
    <div style="margin-bottom: 56px;">
      <div style="display: flex; align-items: center; gap: 14px; margin-bottom: 22px;">
        <div style="width: 44px; height: 44px; background: #E61E38; color: #FFFFFF; border-radius: 12px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/><path d="M12 5 9.04 7.96a2.17 2.17 0 0 0 0 3.08v0c.82.82 2.13.85 3 .07l2.07-1.9a2.82 2.82 0 0 1 3.79-.07l1.72 1.5"/></svg>
        </div>
        <h3 style="font-size: 26px; font-weight: 800; color: #0A192F; font-family: 'Outfit', sans-serif;">
          Our Vision and Commitment to the Indian Traveler
        </h3>
      </div>

      <div style="font-size: 16px; color: #334155; line-height: 1.85; display: flex; flex-direction: column; gap: 20px; background: #FFFFFF; padding: 36px; border-radius: 24px; border: 1px solid rgba(10, 25, 47, 0.1);">
        <p>
